<html> <body> <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
  ...
  </li> </ul> <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect">
  Booking </button> <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect">
